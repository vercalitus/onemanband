...
export const EN_MESSAGES: Record<string, string> = {
  ...
  "bodyMap3d.view.back": "From behind",
  "bodyMap3d.view.front": "From the front",
  "bodyMap3d.view.left": "From the left",
  "bodyMap3d.view.right": "From the right",
  ...
  "bodyMap3d.introDetail":
    "The top buttons jump to a region and turn the model to it; the small ones only change the side. Pen draws on the bone itself, so a mark stays on it when you turn or zoom. Point taps one bone.",
