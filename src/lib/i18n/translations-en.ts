...
export const EN_MESSAGES: Record<string, string> = {
  ...
  "bodyMap3d.mode.rotate": "Rotate",
  "bodyMap3d.mode.pen": "Pen",
  "bodyMap3d.mode.point": "Point",
  "bodyMap3d.region.all": "Whole body",
  "bodyMap3d.region.neck": "Neck",
  "bodyMap3d.region.upperBack": "Upper back",
  "bodyMap3d.region.lowerBack": "Lower back",
  "bodyMap3d.region.pelvis": "Pelvis",
  "bodyMap3d.frozen": "View is frozen — draw on the skeleton",
  "bodyMap3d.controlsHint": "Drag to turn · Shift+drag to move · scroll zooms where the cursor is",
  "bodyMap3d.intro": "Martin — you can zoom in, zoom out, turn the model and mark whatever you need.",
  "bodyMap3d.introDetail":
    "The buttons above the model jump to a region · Pen: the view freezes and you draw freely · Point: tap a bone to choose it.",
  ...
  "bodyMap3d.lab.check1":
    "Turn it, zoom in, and use the region buttons above the model — you can reach a vertebra without the head being cut off.",
  ...
  "bodyMap3d.lab.check3":
    "Pen freezes the view and draws freely — a whole area or a single dot. Point keeps the model turning and taps choose one bone.",
  "bodyMap3d.lab.check4": "Either way you can write a note, and a saved mark remembers the angle it was made from.",
